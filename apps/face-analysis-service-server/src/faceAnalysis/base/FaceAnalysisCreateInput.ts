...
class FaceAnalysisCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => FaceDetectionEventCreateNestedManyWithoutFaceAnalysesInput,
  })
  @ValidateNested()
  @Type(() => FaceDetectionEventCreateNestedManyWithoutFaceAnalysesInput)
  @IsOptional()
  @Field(() => FaceDetectionEventCreateNestedManyWithoutFaceAnalysesInput, {
    nullable: true,
  })
...
export { FaceAnalysisCreateInput as FaceAnalysisCreateInput };
